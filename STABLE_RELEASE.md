...
> **1.2稳定声明仍暂停。** 机器上安装的`1.2.0`/build51来自干净提交`4040a73`；共享1116项（另80项明确跳过）、macOS307项、编译/脚本/资源哈希、冻结冒烟、签名、DMG和事务式安装均通过。Mac锁屏仍阻断同一制品的真实WebView与四项AI点击验收，因此不能提前称稳定版；build24继续作为已验证稳定回退点。

> build51 DMG SHA-256为`8e5d2696037a6679cf533bb52018b380c55ee73a25ef50a08165459492977799`；候选Mac UserKit ZIP SHA-256为`b67fc7e578e270d13e275598c7308d9f693d3f36ed93a02884f3a7abcc266289`。官方资料包继续使用独立版本`1.1.0`，SHA-256为`909cc7323b8a91e3a238e8f49d03fe62022f5a9d078f2cc6785bb8a0b73a69c4`；本轮隔离复核仍为59篇、4,369条、59份PDF和291项视觉资产。

> `0.5.1`/build6继续作为已验证工作流和交互从容度的比较基线；当前安全、原子发布、官方包v2和数据集能力必须保留，不能直接回退旧收费路由或旧DOM。以下旧“稳定交付”段落仅是历史证据，不代表当前1.2可发布。

> 当前可验证回退基线仍为 Auto Research `1.1.0` / build `24`。build51完成干净构建、事务式安装、真实WebView及四项AI验收前不覆盖该结论。Windows 1.2迁移冻结。
