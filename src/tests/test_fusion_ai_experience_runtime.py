...
const label=new El(),detail=new El(),bar=new El(),valueNode=new El(),track=new El();bar.parentElement=track;
...
const progress=new El();progress.map={{'[data-ai-progress-label]':label,'[data-ai-progress-detail]':detail,'[data-ai-progress-bar]':bar,'[data-ai-progress-value]':valueNode}};progress.stages=stages;
