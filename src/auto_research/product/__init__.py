...
_EXPORT_MODULES = {
    ...
    "ActivatedTransferPackage": ".package_transfer_activation",
    "PackageTransferActivationError": ".package_transfer_activation",
    "PackageTransferActivationService": ".package_transfer_activation",
    "LiteratureCollectionPayloadPlanner": ".package_transfer_payloads",
    "PersonalExperimentsPayloadPlanner": ".package_transfer_payloads",
    "audit_transfer_payload_tree": ".package_transfer_payloads",
    "open_transferred_literature_repository": ".package_transfer_payloads",
    "read_personal_transfer_snapshot": ".package_transfer_payloads",
