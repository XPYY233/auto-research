...
def _web_ui_contract() -> dict[str, Any]:
    ...
    expectations = [
        ...
        ("article_navigation_filters", all(item in html for item in ("paper-picker-query", "paper-object-filter", "paper-method-filter", "paper-status-filter", "paper-filter-summary")) and "paperMatchesFilters" in js and "navigation_method_tags" in js and "first_author" in js and "筛选不会切换文章或重新扫描" in html),
