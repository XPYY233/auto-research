...
_EVENTS = MappingProxyType(
    {
        ...
        "literature_initial_focus": ("initial_focus", 24, "双分支提取四类候选"),
        "literature_coverage_gap": ("coverage_gap", 42, "补查遗漏证据"),
        "literature_coverage_verification": ("coverage_verification", 58, "核对覆盖率与来源页"),
        "literature_adversarial_branches": ("adversarial_branches", 73, "比较冲突候选"),
        "literature_third_review": ("third_review", 84, "处理低置信与冲突结果"),
        "literature_publishing": ("publishing", 94, "原子发布并刷新搜索索引"),
