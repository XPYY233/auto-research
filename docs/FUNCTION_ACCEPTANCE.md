...
2026-09-22。当前公开核心任务为 #2–#4；下文旧编号属于私有历史。所有列均以证据为准；源码存在和自动回归通过不等于安装版或科学验收完成。

工程结果以各 PR 的 GitHub Actions 为准；安装候选身份以 [当前交接](../PROJECT_HANDOFF.md#当前安装候选) 及其验收记录为准，后续源码不自动生成安装版。
