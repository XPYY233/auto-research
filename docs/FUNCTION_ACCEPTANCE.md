...
| 审核、原子发布与索引 | review_queue、review_queue_contract、literature_extraction_finalizer、search_index；真实 DTO、数据库/HTTP 回归 | 安装版队列 160 项；新文章 Figure 1/5 实际显示，5 张均经服务核验 | #28 已补发布/审核/目录/索引恢复/重开数据库联合回归；仍需完整安装版实机流程 |
