...
- The canonical portable project skill is this public checkout's `skills/auto-research-evidence-maintainer/`; the installed symlink under `~/.codex/skills/auto-research-evidence-maintainer` must resolve here, not to the protected original research checkout.
