...
- Current release line: Apple Silicon macOS `0.8.0-preview.1` build 18, with final tag/artifact hashes recorded in the user-kit acceptance report. Builds 16 and 17 were stopped by frozen smoke gates before any App/DMG was released. It remains an internal preview; build 15/source `888aae5` is the independent 0.7 rollback.
