...
- Current desktop checkpoint: Apple Silicon macOS `0.5.1-preview.1`, artifact source `63b34f2`, tag `evidence-demo-2026-08-09-macos-workbench-preview-5`. It remains an internal development preview whose editable literature workspace depends on the checkout schema-v12 database, not a portable stable release. The clean release worktree passed 726 tests (467 core / 154 macOS / 105 Windows contracts); the App/DMG passed frozen smoke, ad-hoc signing, image verification and installed GUI inspection. Final DMG SHA-256: `7646527a9d7e59a64a11fdb9beb91f36b49b0eea12ae4d11b459db7e946b4529`.
