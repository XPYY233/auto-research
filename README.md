...
Last built desktop checkpoint: **Auto Research `0.5.0-preview.1` for Apple Silicon macOS**, artifact-tagged `evidence-demo-2026-08-09-macos-workbench-preview-4` from `9985386`. It is an internal development preview, not a portable public release: the editable local-literature workspace still depends on this checkout and the schema-v12 database. The clean release worktree passed 722 automated tests (467 shared core, 151 macOS and 104 Windows contracts), frozen App smoke, ad-hoc signing, DMG verification and an isolated GUI process launch/clean shutdown. The DMG SHA-256 is `cad6c8b8f2769b9006a0820fabf9ee22f03ca36ae5593f6f2e96adc88f2374a1`.
