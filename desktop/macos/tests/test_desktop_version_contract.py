...
class DesktopVersionContractTests(unittest.TestCase):
    def test_launcher_uses_release_contract_generated_version_json(self) -> None:
        ...
        self.assertEqual(launcher.DESKTOP_VERSION, "0.9.2-preview.1")
        self.assertEqual(metadata["bundle_short_version"], "0.9.2")
        self.assertEqual(metadata["build_number"], "21")
        self.assertEqual(metadata["target"], "macOS arm64 Fusion visual evidence preview")
