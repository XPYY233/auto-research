...
class PackageJobStateTests(unittest.TestCase):
    ...
    def test_error_mapping_is_stable_and_does_not_echo_internal_details(self) -> None:
        cases = (
            ...
            ("untrusted_package_identity", PackageJobStage.AUDIT_REPOSITORY, "package_untrusted", False),
            ...
            ("untrusted_rights_scope", PackageJobStage.AUDIT_REPOSITORY, "package_rights_invalid", False),
