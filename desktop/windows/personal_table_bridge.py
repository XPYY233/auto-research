...
class WindowsPersonalTableBridge:
    """Windows HTTP projection over the shared read-only table service."""
    ...
    def handle_get(self, handler: PersonalTableHTTPHandler) -> bool:
        ...
        try:
            ...
            error = exc if isinstance(exc, PersonalTableError) else PersonalTableError(
                "personal_table_invalid"
            )
...
__all__ = ["WindowsPersonalTableBridge"]
