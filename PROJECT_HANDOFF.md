...
## v1.1.0 build 42 Mac 候选（2026-08-25，当前开发权威）

- 当前安装版为 build 41；build 24 仍是已验证稳定回退点，build 40另有不可启动回退副本。build 42 保持 `1.1.0` 语义版本，只有干净提交构建、事务式安装、真实 WebView 和四项付费 AI 验收全部通过后，才能替换稳定结论。
